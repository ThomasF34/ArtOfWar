from arriere.py import *
from carte.py import *
from champBataille.py import *
from cimetiere.py import *
from front.py import *
from joueur.py import *
from mainJoueur.py import *
from partie.py import *
from pioche.py import *
from reserve.py import *
from royaume.py import *
...
def testNomJoueur(Joueur):
    ...
    if nom(Joueur) == "Joueur1":
        print("#Test x : La fonction nom() affiche correctement le nom du joueur")
    else:
        print("#Test x : Erreur, la fonction nom() ne renvoi pas la bonne valeur")
...
def testNbCarteArriere(front(Joueur1)):
    print("# Test 18:")
    if nbCarteFront(front) == 1:
